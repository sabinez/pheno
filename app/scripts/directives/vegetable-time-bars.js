        ...
        <li class="target-tween-tomato">\
          <div class="calendar-time-bars">\
            <div style="display:flex;">\
              ...
              <div class="calendar-time-bar sowing time-bar-sowing-2nd-{{plant.URL}}" ng-if="plant.TIMES.SOWING[2]" style="width:0;margin-left:{{plant.sowingMarginSecond + plant.sowingWidth}}px;"> sow</div>\
            </div>\
            ...
            <div style="display:flex;">\
              ...
              <div class="calendar-time-bar harvesting time-bar-harvesting-2nd-{{plant.URL}}" ng-if="plant.TIMES.HARVESTING[2]" style="width:0;margin-left:{{plant.harvestingMarginSecond + plant.harvestingWidth}}px;"> harvest</div>\
            </div>\
          </div>\
        </li>'
    };
